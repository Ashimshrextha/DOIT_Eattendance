...
{
    public class HRCompanyHREmployeeBulkKaajServices : BaseRepository<HREmployeeKaajHistory, HRCompanyHREmployeeBulkKaajModel>, IHRCompanyHREmployeeCovidKaajServices<HREmployeeKaajHistory, HRCompanyHREmployeeBulkKaajModel>
    {
        public HRCompanyHREmployeeBulkKaajServices(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
            if (unitOfWork == null)
            {
